    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <div class="flex gap-2">
                ...
                <a href="index.php?f=Selesai" class="px-5 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest <?= $filter_status == 'Selesai' ? 'bg-yello-600 text-white' : 'bg-white/5 text-gray-500 hover:bg-white/10' ?> transition-all flex items-center">Selesai</a>
            </div>
        </div>
