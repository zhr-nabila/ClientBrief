...
<head>
    ...
    <style>
        ...
        /* Animasi Modal */
        #imageModal.active { display: flex; animation: fadeIn 0.3s ease; }
                                ...
                                <tr class="hover:bg-white/[0.02] transition-colors group">
                                    ...
                                    <td class="p-6 text-right">
                                        <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <?php 
                                                // Bersihkan nomor telepon agar hanya angka
                                                $wa_number = preg_replace('/[^0-9]/', '', $row['no_telp']);
                                            ...
                                            <?php if (!empty($row['nama_file'])): ?>
                                                <button onclick="openPreview('../Uploads/<?= $row['nama_file'] ?>')" class="p-3 bg-white/5 rounded-xl hover:bg-white/20 transition-all text-white" title="Lihat Referensi">
