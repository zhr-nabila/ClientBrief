...
<head>
    ...
    <style>
        ...
        .divider {
            border: none;
            height: 1px;
            background: linear-gradient(90deg, transparent 0%, rgba(179, 44, 26, 0.3) 50%, transparent 100%);
            margin: 2rem 0;
        }
        ...
        <div class="glass-card rounded-2xl p-6 md:p-8">
            <form action="update_status.php" method="POST" class="space-y-8">
                ...
                <div>
                    ...
                    <textarea name="keterangan_admin" rows="4" class="input-field" placeholder="Tambahkan catatan progres di sini..."><?= htmlspecialchars($data['keterangan_admin']) ?></textarea>
                </div>
