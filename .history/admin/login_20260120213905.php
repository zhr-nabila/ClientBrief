...
<head>
    ...
    <style>
        body {
            ...
            background: #1a1a1a; /* Pastikan ada background agar efek blur terlihat */
        }
    </style>
</head>
    ...
    <div class="w-full max-w-md bg-white/[0.02] border border-white/10 p-10 rounded-[32px] backdrop-blur-xl shadow-2xl">
        ...
        <form method="POST" class="space-y-4">
            ...
            <button type="submit" name="login" 
                class="w-full bg-blue-600 py-4 rounded-2xl font-bold text-white mt-4 hover:bg-blue-700 transition shadow-lg shadow-blue-600/20 active:scale-[0.98]">
                Masuk
            </button>
        </form>
    </div>
