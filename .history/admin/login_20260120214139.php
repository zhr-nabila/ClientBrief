...
<head>
    ...
    <style>
        /* CSS ini untuk memastikan saat 'Autofill' (input terisi otomatis), 
           background tetap transparan/blur dan tidak berubah jadi putih/biru */
        ...
        <form method="POST" class="space-y-4">
            <div>
                ...
                <input type="text" name="username" 
                    class="w-full bg-white/5 border border-white/10 p-4 rounded-xl text-white outline-none focus:border-blue-500 transition backdrop-blur-md" 
                    required>
            </div>
            <div>
