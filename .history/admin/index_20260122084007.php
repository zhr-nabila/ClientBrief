...
<body class="p-6 md:p-12">
    ...
    <div id="imageModal" class="fixed inset-0 z-[100] hidden flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm" onclick="closePreview()">
    
    <div class="relative max-w-4xl w-full flex flex-col items-center justify-center" onclick="event.stopPropagation()">
        
        <button onclick="closePreview()" class="absolute -top-10 right-0 md:-right-10 text-white hover:text-red-500 transition-all flex items-center gap-2 font-bold uppercase tracking-widest text-xs">
            Tutup <i data-lucide="x" class="w-6 h-6"></i>
        </button>

        <img id="modalImg" src="" class="max-h-[85vh] max-w-full w-auto rounded-2xl shadow-2xl border border-white/10 object-contain">
