...
// 2. Logika Statistik (Tetap menghitung total keseluruhan)
                                    ...
                                    <td class="p-6 text-right">
                                        <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <?php if (!empty($row['nama_file'])): ?>
                                                <button onclick="openPreview('../Uploads/<?= $row['nama_file'] ?>')" class="p-3 bg-white/5 rounded-xl hover:bg-green-600 transition-all text-green-400 hover:text-white">
                                                    <i data-lucide="image" class="w-4 h-4"></i>
                                                </button>
                                            <?php else: ?>
                                                <button class="p-3 bg-white/5 rounded-xl opacity-30 cursor-not-allowed">
