...
<head>
    ...
    <style>
        ...
        /* Penyesuaian khusus input bendera */
        .iti { width: 100%; }
...
<body class="min-h-screen hero-gradient flex items-center justify-center p-6">
    ...
    <script>
        ...
        // Update input hidden tiap kali user ngetik nomor
        ...
        function toggleLang() {
            ...
            inputTel.placeholder = dict.telp; // Update placeholder telpon
        ...
        function validateAndNext(currentStep, nextStep) {
            ...
            // Cek input telpon secara manual karena dia dibungkus library
