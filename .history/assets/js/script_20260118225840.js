...
const dictionary = {
    ID: {
        ...
        pesan: "Jelaskan kebutuhan proyek Anda secara singkat dan jelas. Contoh: 'Website company profile dengan 5 halaman utama.'",
    ...
    EN: {
        ...
        pesan: "Describe your project needs briefly and clearly. Example: 'Company profile website with 5 main pages.'",
...
// ===== INITIALIZE INTEGRATED TELEPHONE INPUT =====
let iti;
if (inputTel) {
    ...
    // ===== TELEPHONE INPUT VALIDATION (NUMERIC ONLY) =====
...
function updateFullNumber() {
    if (fullPhoneInput && iti) {
        ...
        // Remove all non-numeric characters for database
