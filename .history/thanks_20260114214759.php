...
<body class="bg-[#050810] text-white flex items-center justify-center min-h-screen p-6">
    <div class="text-center">
        ...
        <p class="text-gray-400 mb-10 max-w-sm mx-auto">Terima kasih. Data Anda sudah masuk ke sistem kami. Kami akan menghubungi Anda segera melalui WhatsApp.</p>
