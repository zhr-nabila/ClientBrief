                ...
                <div id="step-2" class="step-content space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="service-select">
                            <div class="service-selected" id="serviceSelected">
                                Pilih Layanan
                                <i data-lucide="chevron-down"></i>
                            </div>

                            <div class="service-options">
                                <div class="service-option" data-value="Web Development">Web Development</div>
                                <div class="service-option" data-value="UI/UX Design">UI/UX Design</div>
                                <div class="service-option" data-value="Digital Marketing">Digital Marketing</div>
                            </div>

                            <!-- REAL SELECT (HIDDEN, BACKEND AMAN) -->
                            <select name="jasa" id="in-jasa" required hidden>
                                <option value=""></option>
